...
const DRAFT_KEY = "d-log-v6-1-1-draft";
...
export default function Home() {
  ...
  function addExercise(exercise) {
    ...
    setExercises((current) => [...current, { ...exercise, sets: Number(exercise.sets) || 3 }]);
  ...
  function saveLog(log, exercise) {
    ...
    if (nextComplete) startRestTimer(exercise, log);
  }
    ...
    <main>
      <header className="brandHeader">
        <div className="brandLockup">
          <DLogo />
          <div>
            <div className="eyebrow">D-log · v6.1.1</div>
