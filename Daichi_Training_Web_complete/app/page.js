...
const DRAFT_KEY = "d-training-v5-draft";
const REST_SECONDS = 90;

function DLogo({ className = "dLogo" }) {
  return (
    <svg className={className} viewBox="0 0 100 100" role="img" aria-label="D logo">
      <path fill="currentColor" d="M16 10h31c26.5 0 48 21.5 48 48S73.5 94 47 94H16V37h15v42h16c18.2 0 33-14.8 33-33S65.2 25 47 25H16V10Z" />
    </svg>
  );
}
    ...
    <main>
      <header className="brandHeader">
        <div className="brandLockup">
          <DLogo />
          <div>
            <div className="eyebrow">D · v5.0</div>
      ...
      {!workout && (
        <>
          ...
          <section className="todayPlan card">
            <div>
              <small>WORKOUT PLAN</small>
              <strong>予定はNotionから読み込む</strong>
              <span>アプリ内に固定スケジュールは持たせません。</span>
            </div>
          </section>
